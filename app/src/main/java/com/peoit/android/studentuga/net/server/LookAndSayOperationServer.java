 ...
 * last: ...
 */
public class LookAndSayOperationServer extends BaseServer {
    private final String url = NetConstants.HOST + "addCommodSS.do";

    public LookAndSayOperationServer(ActivityBase activityBase) {
        super(activityBase);
    }

    public void requestAddlookAndSay(String text,
                                     String img1,
                                     String img2,
                                     String img3,
                                     String img4,
        ...
        mActBase.showLoadingDialog("正在保存动态...");
