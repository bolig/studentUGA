...
public class AliPayBuilder {
	...
	private String partner = "partner=" + "\"" + "2088121043034974" + "\"";      // 签约合作者身份ID(PID)
	private String seller_id = "&seller_id=" + "\"" + "2377386905@qq.com" + "\"";   // 签约卖家支付宝账号
	...
	private String notify_url = "&notify_url=" + "\""
			+ NetConstants.HOST + "payverify.do" + "\"";                          // 服务器异步通知页面路径
