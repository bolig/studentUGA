...
package com.peoit.android.studentuga.view.wheel;
...
import com.peoit.android.studentuga.view.wheel.adapter.WheelViewAdapter;
...
public class WheelView extends View {
    ...
    private void drawCenterRect(Canvas canvas) {
        ...
        paint.setColor(getResources().getColor(R.color.col_main));
        // 设置线宽
