 ...
 * last: ...
 */
public class CommonAdapter extends BaseListAdapter<CommonInfo> {
    public CommonAdapter(Activity mAc) {
        super(mAc);
    }
    ...
    @Override
    protected void initView(int position, CommonInfo data, ViewHolderBase holderBase, View convertView) {
