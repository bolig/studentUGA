 ...
 * last: ...
 */
public class MyTeacherAdapter1 extends BaseListAdapter<BindInfo> {

    public MyTeacherAdapter1(Activity mAc) {
        super(mAc);
    }

    public MyTeacherAdapter1(Fragment fragment) {
        super(fragment);
    }
    ...
    @Override
    protected void initView(int position, BindInfo data, ViewHolderBase holderBase, View convertView) {
